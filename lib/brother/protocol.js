...
// ESC i z sets the media layout and raster line count for the current job.
const buildPrintInfo = ({ mediaType = 0, mediaWidthMm = 0, mediaLengthMm = 0, rasterLines = 0, isLastPage = true }) => {
...
// ESC i K selects the cut mode. 0x08 = standard cut at end of print.
